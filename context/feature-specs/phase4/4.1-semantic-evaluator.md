...
6. `semantic_evaluator` runs end-to-end against the loaded POLE graph — `_execute_ground_truth`
   hits the real driver and a benchmark question's gold result set is compared for real.
