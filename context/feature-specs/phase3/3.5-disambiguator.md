...
`previously_tried` lifecycle (orchestrator-owned, per 0.1): accumulates across disambiguation
retries on the **same** `CandidateMapping`; cleared on a Schema Linker outer-loop reset.
